         ...
         -->
            <?php 
                ...
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                    ...
                    $sql = "INSERT INTO bakery_employees (default_loc, first_name, last_name, employee_type) VALUES (?, ?, ?, ?)";
                    ...
                    if($stmt = mysqli_prepare($link, $sql)){
                        ...
                        mysqli_stmt_bind_param($stmt, "ssss", $param_location, $param_first_name, $param_last_name, $param_employee_type);
